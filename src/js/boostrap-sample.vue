	...
	.container-fluid
		...
		section.maincolumn
			.container(role="main")
				...
				.page-header
					h1 Thumbnails
				img.img-thumbnail(src='img/janux-sage-256.png', alt='A generic square placeholder image with a white border around it, making it resemble a photograph taken with an old instant camera')
				...
				.progress
					.progress-bar.progress-bar-striped(role='progressbar', aria-valuenow='60', aria-valuemin='0', aria-valuemax='100', style='width: 60%')
						span.sr-only 60% Complete
				.progress
